...
#ifndef DCIM_SUBARRAY_H_
#define DCIM_SUBARRAY_H_
...
class Dcim_SubArray: public FunctionUnit {
public:
	Dcim_SubArray(InputParameter& _inputParameter, Technology& _tech, MemCell& _cell);
	virtual ~Dcim_SubArray() {}
