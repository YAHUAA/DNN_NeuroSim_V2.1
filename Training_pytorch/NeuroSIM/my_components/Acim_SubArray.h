...
#ifndef ACIM_SUBARRAY_H_
#define ACIM_SUBARRAY_H_
...
class Acim_SubArray: public FunctionUnit {
public:
	Acim_SubArray(InputParameter& _inputParameter, Technology& _tech, MemCell& _cell);
	virtual ~Acim_SubArray() {}
